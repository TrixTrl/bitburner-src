...
import { /*calculateRamUsage,*/ type RamUsageEntry } from "../Script/RamCalculations";
...
export class Script extends ContentFile {
  ...
  updateRamUsage(/*otherScripts: Map<ScriptFilePath, Script>*/): void {
    const ramCalc = { cost: 2, entries: [], errorMessage: null }; // calculateRamUsage(this.code, this.filename, this.server, otherScripts);
